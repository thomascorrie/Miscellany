...
namespace Miscellany.ContainerPacking
{
    ...
    public static partial class PackingService
    {
        ...
        public static Dictionary<string, object> PackContainer(Miscellany.ContainerPacking.Entities.Container container, List<Miscellany.ContainerPacking.Entities.Item> itemsToPack, int algorithm = 1)
        {
            ...
            double PercentContainerVolumePacked = Miscellany.Maths.Functions.ToDouble(algorithmPackingResult.PercentContainerVolumePacked);
            double PercentItemVolumePacked = Miscellany.Maths.Functions.ToDouble(algorithmPackingResult.PercentItemVolumePacked);
        ...
        {
            double ddim1 = Miscellany.Maths.Functions.ToDouble(i.Dim1);
            double ddim2 = Miscellany.Maths.Functions.ToDouble(i.Dim2);
            double ddim3 = Miscellany.Maths.Functions.ToDouble(i.Dim3);
            //Create Item
            ...
            if (i.IsPacked)
            {
                ...
                mItem.PackDimX = Miscellany.Maths.Functions.ToDouble(i.PackDimX);
                mItem.PackDimY = Miscellany.Maths.Functions.ToDouble(i.PackDimZ);
                mItem.PackDimZ = Miscellany.Maths.Functions.ToDouble(i.PackDimY);
                mItem.CoordX = Miscellany.Maths.Functions.ToDouble(i.CoordX);
                mItem.CoordY = Miscellany.Maths.Functions.ToDouble(i.CoordZ);
                mItem.CoordZ = Miscellany.Maths.Functions.ToDouble(i.CoordY);
            }
            return mItem;
        }
        ...
        {
            decimal dLength = Miscellany.Maths.Functions.ToDecimal(c.Length);
            decimal dWidth = Miscellany.Maths.Functions.ToDecimal(c.Width);
            decimal dHeight = Miscellany.Maths.Functions.ToDecimal(c.Height);
        ...
        {
            decimal ddim1 = Miscellany.Maths.Functions.ToDecimal(i.Dim1);
            decimal ddim2 = Miscellany.Maths.Functions.ToDecimal(i.Dim2);
            decimal ddim3 = Miscellany.Maths.Functions.ToDecimal(i.Dim3);
